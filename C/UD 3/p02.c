/** Realizzare un programma che gestisca una lista della spesa contenente ipotetici prodotti. 
 *  Ogni PRODOTTO ha come informazioni il nome, la quantità ed il prezzo unitario(prezzo del singolo prodotto). 
